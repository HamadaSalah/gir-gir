...
<section class="search__results bg-main  ">
    ...
    width: 100%;height: 42px;">
                ...
                <form style="display: inline-block;" id="myForm" style="margin-bottom: 0" onsubmit="reloadPageWithParams(event)">
                    <select id="myInput" name="type" class="form-select border-0 text-black-50 bg-main" style="padding: 0 30px; 0 10px" onchange="document.getElementById('myForm').submit();">
