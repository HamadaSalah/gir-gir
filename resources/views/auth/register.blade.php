          ...
          <form class="form p-2" method="POST" action="">
            ...
            <div class="row mb-4">
              <div class="col-6">
                <input
                  ...
                  class="form-control rounded-5 bg-secondary border-0 @error('first_name') is-invalid @enderror"
              ...
              <div class="col-6">
                <input
                  ...
                  name="last_name"
                  value="{{ old('last_name') }}"
                  class="form-control rounded rounded-5 bg-secondary border-0 @error('last_name') is-invalid @enderror"
            ...
            <div class="input-group">
              ...
              <input
                ...
                name="phone"
                value="{{old('phone')}}"
                class="form-control w-50 rounded-end-5 bg-secondary border-0 @error('phone') is-invalid @enderror"
