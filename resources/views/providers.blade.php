        ...
        <div class="col-lg-6  ">
            <div class="ProviderClass ProviderClass2">
                ...
                <img src="{{ asset($shop->files[0]?->path ?? '') }}" alt="wedding"
                    class="card-img-top img-fluid rounded-3" style="width: 50%;float: left;margin-right: 10px;"/>
    
                <div class="card-body rounded-5 px-1 py-2 bg-white">
                    ...
                    <p class="card-text text-black fs-14 ls-5 fm-cairo mb-2">
                        ...
                        <span class="text-secondary text-black-50">
                            {{ strlen($shop->description) > 100 ? substr($shop->description, 0, 100) . '...' : $shop->description ?? 'No Description Provided' }}
                        </span>
                    </p>
                    <p class="card-text text-black fs-14 ls-5 fm-cairo mb-2">
                        Provider Type :
